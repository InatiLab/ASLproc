...
# Syntax:       python3 doVol_predict_rsxn.py EIG_DIR
# Arguments:    EIG_DIR: path to EIG_DIR
# Description:  Predicts tissue classes.
# Requirements: --
# Notes:  		Called in MRI_do_predict.sh
...
pwd_dir = os.getcwd()
top_dir = os.path.dirname(pwd_dir)
text_dir=top_dir+'/features/'
wdir=pwd_dir+'/'
clf_dir=eig_dir+'/Projects/resection_mask/classifier/'
...
def loadData(text_dir):
	input_images=[text_dir+'t1_features.nii', text_dir+'t2_features.nii', text_dir+'fl_features.nii']
