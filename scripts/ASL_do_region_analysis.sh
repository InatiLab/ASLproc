...
regional_dir=${subj_data_dir}/regional_analysis
BN_dir=${scripts_dir}/__files/brainnetome
#====================================================================================================================
...
3dresample -master ${subj}_cbf_divMed-smooth5mm.nii -inset ${BN_dir}/BN_Atlas_regional.nii -prefix ${regional_dir}/${subj}_BN_regional.rs.nii
...
3dresample -master ${subj}_cbf_divMed-smooth5mm.nii -inset ${BN_dir}/BN_Atlas_focal.nii -prefix ${regional_dir}/${subj}_BN_focal.rs.nii
...
3dresample -master ${subj}_cbf_divMed-smooth5mm.nii -inset ${BN_dir}/BN_Atlas_regional_all-apLTL.nii -prefix ${regional_dir}/${subj}_BN_regional-apLTL.rs.nii
...
3dresample -master ${subj}_cbf_divMed-smooth5mm.nii -inset ${BN_dir}/BN_Atlas_focal_all-apLTL.nii -prefix ${regional_dir}/${subj}_BN_focal-apLTL.rs.nii
