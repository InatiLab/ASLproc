...
cd ${proc_dir}
3dcopy ${wdir}/alignMNI/cbf_ss_mni.nii cbf_mni
3dAFNItoNIFTI cbf_mni+tlrc. cbf_mni.nii
...
3dresample -master cbf_mni-smooth5mm.nii -inset ${files_dir}/BN_Atlas_246_1mm.nii.gz -prefix BN_atlas_cbf-smooth5mm.rs
...
3dresample -master ${subj}_cbf_divMed-smooth5mm.nii -inset ${files_dir}/BN_Atlas_246_1mm.nii.gz -prefix BN_atlas_cbf_divMed-smooth5mm.rs
3dresample -master ${proc_dir}/cbf_mni-smooth5mm.nii -inset ${files_dir}/BN_Atlas_246_1mm.nii.gz -prefix BN_atlas_cbf-smooth5mm.rs
